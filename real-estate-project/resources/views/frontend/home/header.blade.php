...
@php
    // Fetch site settings with a null check
    $setting = App\Models\SiteSetting::find(1);
@endphp
...
<header class="main-header">
            ...
            <div class="left-column pull-left">
                <ul class="info clearfix">
                    @if($setting)
                        ...
                        <li><i class="far fa-phone"></i><a href="tel:2512353256">+{{ $setting->support_phone }}</a></li>
                    @else
                        <!-- Optional: Provide default or fallback content when setting is null -->
                        <li>Company address not available</li>
                        <li>Support phone not available</li>
                    @endif
                </ul>
            </div>
            <div class="right-column pull-right">
    ...
    <div class="header-lower">
        <div class="outer-box">
            <div class="main-box">
                <div class="logo-box">
                    <figure class="logo"><a href="{{ url('/') }}"><img src="{{ asset($setting ? $setting->logo : '') }}" alt=""></a></figure>
                </div>
                <div class="menu-area clearfix">
                    <!--Mobile Navigation Toggler-->
                    <div class="mobile-nav-toggler">
